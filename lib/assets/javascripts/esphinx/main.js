...
// siblings, childrens and multiple heritage.
// está aceitando mais de um atributo, isso é correto?
// ( *((((([.#]{1}|\:{1,2})?\w+)|\*{1})(\[{1} *\w+ *(([\^$|~*]?={1} *)?(\w+|#|((\\'){1}(\w+|#)(\\'){1})|((\\"){1}(\w+|#)(\\"){1})|('{1}(\w+|#)'{1})))?( *\]{1}))*)|(\[{1} *\w+(([\^$|~*]?={1} *)?(\w+|#|((\\'){1}(\w+|#)(\\'){1})|((\\"){1}(\w+|#)(\\"){1})|('{1}(\w+|#)'{1})))?(\]{1}))+)((([.#]{1}|\:{1,2})\w+)*(( +|( *[,~>+]{1} *))((((([.#]{1}|\:{1,2})?\w+)|\*{1})(\[{1}\w+(([\^$|~*]?={1} *)?(\w+|#|((\\'){1}(\w+|#)(\\'){1})|((\\"){1}(\w+|#)(\\"){1})|('{1}(\w+|#)'{1})))?(\]{1}))*)|(\[{1}\w+(([\^$|~*]?={1} *)?(\w+|#|((\\'){1}(\w+|#)(\\'){1})|((\\"){1}(\w+|#)(\\"){1})|('{1}(\w+|#)'{1})))?(\]{1}))+))*)* *(?!.))

// (\[{1}\w+(([\^$|~*]?={1})?(\w+|((\\'){1}(\w+|#)(\\'){1})|((\\"){1}(\w+|#)(\\"){1})|('{1}(\w+|#)'{1})))?(\]{1}))+