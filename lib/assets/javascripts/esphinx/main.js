...
// heritage. Falta suporte a attributos
// (((([.#]{1}|\:{1,2})\w+)(([.#]{1}|\:{1,2})?\w+( +([.#]{1}|\:{1,2})?\w+)*)*)|(\w+)(([.#]{1}|\:{1,2})?\w+)+(([.#]{1}|\:{1,2})\w+( +([.#]{1}|\:{1,2})?\w+)*)+ *(?!.))


// siblings, childrens and multiple heritage
// só falta o suporte a attributos, já suporta ~, >...
// (((([.#]{1}|\:{1,2})\w+)(([.#]{1}|\:{1,2})?\w+( *[,~>+]{1} *([.#]{1}|\:{1,2})?\w+)*)*)|(\w+)(([.#]{1}|\:{1,2})?\w+)+(([.#]{1}|\:{1,2})\w+( *[,~>+]{1} *([.#]{1}|\:{1,2})?\w+)*)+ *(?!.))
