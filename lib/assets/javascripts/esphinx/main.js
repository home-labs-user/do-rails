    ...
    return function esPhinx (selector, context) {
        ...
        if (selector) {
            ...
            if (selector instanceof $) {
                ...
                // recognize a tag
                if (/( *<[a-zA-Z]+( +(\w|\w+-+\w*)+ *= *((\\" *.+ *\\")|(\\' *.+ *\\')|( *. *)|((') *.+ *(')|((") *.+ *(")))))* *((\/)|(>.*<\/[a-zA-Z]+))(> *$))/gy.test(selector)) {
                    ...
                    if (Iterator.isIterable(context)) {
                        ...
                        if (/( *(((([a-zA-Z]+)|([.#](\w|\w+-+\w*)+)|(:{1,2}(\w|\w+-\w+)+(\([a-zA-Z0-9]+\))?)|(\*))(\[ *\w+ *(([\^$|~*]?= *)?((\w|\w+-+\w*)+|((\\') *.+ *(\\'))|((\\") *.+ *(\\"))|((') *.+ *('))|((") *.+ *("))))?( *\]))*)|(\[ *\w+ *(([\^$|~*]?= *)?((\w|\w+-+\w*)+|((\\') *.+ *(\\'))|((\\") *.+ *(\\"))|((') *.+ *('))|((") *.+ *("))))?( *\]))+)((([a-zA-Z]+)|([.#](\w|\w+-+\w*)+)|(:{1,2}(\w|\w+-\w+)+(\([a-zA-Z0-9]+\))?)|(\*))*(( +|( *[,~>+] *))(((([a-zA-Z]+)|([.#](\w|\w+-+\w*)+)|(:{1,2}(\w|\w+-\w+)+(\([a-zA-Z0-9]+\))?)|(\*))(\[ *\w+ *(([\^$|~*]?= *)?((\w|\w+-+\w*)+|((\\') *.+ *(\\'))|((\\") *.+ *(\\"))|(' *.+ *')|((") *.+ *("))))?( *\]))*)|(\[ *\w+ *(([\^$|~*]?= *)?((\w|\w+-+\w*)+|((\\') *.+ *(\\'))|((\\") *.+ *(\\"))|((') *.+ *('))|((") *.+ *("))))?( *\]))+))*)* *(?!.))/gy.test(selector)) {
                            collection = Array
...
// replace to
// (([a-zA-Z]+)|([.#](\w|\w+-+\w*)+)|(:{1,2}(\w|\w+-\w+)+(\([a-zA-Z0-9]+\))?)|(\*))
