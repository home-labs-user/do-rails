...
(function ($module) {
    ...
    Object.defineProperties(esPhinx.Extensor, {
        new: {
            value: function (object, final, structure) {
                ...
                iterator.selectInDepth(function (body, name, trace) {
    ...
    esPhinx.extend(true, {
        ...
        selectEach: function(enumerable, callback) {
            var
                iterator = Iterator.new(enumerable);

            return iterator.selectEach(callback);
        },

        selectInDepth: function(enumerable, callback) {
            var
                iterator = Iterator.new(enumerable);

            return iterator.selectInDepth(callback);
        }
