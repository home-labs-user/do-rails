    ...
    return function esPhinx (selector, context) {
        ...
        if (selector) {
            ...
            if (selector instanceof $) {
                ...
                selector_pattern = /( *((?:[a-zA-Z]+)|(?:[.#]\w+(?:-+\w*)*)+|(?::\w+(?:-\w+)*(?:\([a-zA-Z0-9]+\))?)+|(?::{2}\w+(?:-\w+)*)+|(?:\*)|(?:\w*\[ *\w+(?:-+\w*)* *(?:(?:[\^$|~*]?= *)?(?:(?:\w+(?:-+\w*)*)|(?:\\' (?:\w+-*)+ *\\')|(?:\\" (?:\w+-*)+ *\\")|(?:' (?:\w+-*)+ *')|(?:" (?:\w+-*)+ *")))?(?: *\]))+)(?:(?: *(?:[,~>+] *)?(?:(?:[.#]\w+(?:-+\w*)*)+|(?::\w+(?:-\w+)*(?:\([a-zA-Z0-9]+\))?)+|(?::{2}\w+(?:-\w+)*)+|(?:\w*\[ *\w+(?:-+\w*)* *(?:(?:[\^$|~*]?= *)?(?:(?:\w+(?:-+\w*)*)|(?:\\' (?:\w+-*)+ *\\')|(?:\\" (?:\w+-*)+ *\\")|(?:' (?:\w+-*)+ *')|(?:" (?:\w+-*)+ *")))?(?: *\]))+)*)|(?:(?:(?: *[,~>+] *)| +)(?:(?:[a-zA-Z]+)|\*))+)* *(?!.))/;
