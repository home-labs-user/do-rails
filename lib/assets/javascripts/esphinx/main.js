        ...
        Extender = {
            extend: function(object, final, structure) {
                var
                    ...
                    // create or mount the context. If there is trace and body type is an Object, but it doesn't exists, it will be created, if exists, it will be mounted. This operation is repeated until the body is a type function.
                    mountContext = function(trace) {
                        var
                            context = object;

                        trace.forEach(function(v) {
                            if (!Object.includeProperties(context, v)) {
                                context[v] = {};
                            }
                    ...
                    hasAnyAccessor = function(body) {
                        return Object.includeProperties(body, "get") ||
                         Object.includeProperties(body, "set");
                    },
                ...
                strategy.research(function(body, name, trace) {
                    ...
                    if ((trace.length && !isAnAccessor(name, trace)) ||
                        name != "get" && name != "set") {
                    ...
                    // se body for object e incluir get ou set para acessá-lo ou definí-lo, entra aqui
                    // if (Object.isFromClass(body, Object) &&
                    //     hasAnyAccessor(body)) {
                    //     try {
                    //         Object.defineProperty(context, name, {
                    //             get: body.get || function() {},
                    //             set: body.set || function() {},
                    //             enumerable: enumerable
                    //         });
                    //     } catch (e) {
                    //         informeIf(verbose);
                    //     }
                    // } else if (!isAnAccessor(name, trace)) {
                    //     // ou body é object mas não define get e nem set, ou body é outro tipo de objeto
                    //     if (Object.isFromClass(body, Object) &&
                    //         isEmpty(body)) {
                    //         value = {};
                    //     } else {
