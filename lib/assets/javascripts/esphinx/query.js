        ...
        prototype: {
            ...
            prev: function (node) {
                var
                    ...
                    hasSibling = function (node, comparator) {
                        do  {
                            if (node.isEqualNode(comparator)) {
                                return node;
                            }
                        // while sibling
                ...
                if (node) {
                    ...
                    if (query.any()) {
                        self.each(function (node) {
                            sibling = hasSibling(self.first(), node);
                            // por que testar se é instância de Node???
