...
(function ($) {
    ...
    $.prototype.extend({
        ...
        selectByText: function (text, modifier) {
            var
                collection = $();

            this.selectEach(function (node) {
                collection.concat(true, document.evaluate(
                    "descendant-or-self::*[text()='" + text + "']", node)
                    .elements());
            });
        ...
        childElements: function (comparator) {
            ...
            if (this.some()) {
                ...
                if (comparator) {
                    ...
                    $(node.children).selectEach(function (element) {
                        element = $(element);
                        comparators.selectEach(function (comparator) {
        ...
        filter: function (callback) {
            ...
            this.selectEach(function (node, i) {
        ...
        parent: function (query) {
            ...
            if (query) {
                ...
                // }
                this.selectEach(function (element) {
        ...
        // sort: function (order = "asc") {
            ...
            asArray.forEach(function (text) {
                // concatened.concat(true, $(text, mainReference));
                concatened.concat(true, mainReference.selectByText(text));
            });
