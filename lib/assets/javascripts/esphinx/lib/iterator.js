        ...
        new: {
            ...
            value: function (enumerable) {
                ...
                if (!(this instanceof self.new)) {
                    // return new self.new(enumerable, callback);
                ...
                this.selectEach = function (callback) {
                    var
                        selected = [],
                        returned,
                        current;
                    ...
                    if (count) {
                        do {
                            ...
                            returned = callback.call(enumerable, current, i);
                            if (returned) {
                ...
                this.selectInDepth = function (callback) {
                    var
