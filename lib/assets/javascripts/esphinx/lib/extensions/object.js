    ...
    var
        areEquivalents = function(object1, object2) {
            var
                ...
                iteratorBlock = function(attribute) {
        ...
        $.defineProperties($, {
            ...
            clone: {
                value: function(object, includeNonEnumerable) {
                    ...
                    try{
                        properties.forEach(iteratorBlock);
                    } catch(e) {}
            ...
            reverse: {
                value: function(object) {
                    var
                        ...
                        iteratorBlock = function(k) {
                            newObject[k] = object[k];
                        };

                    $.keys(object).reverse().forEach(iteratorBlock);
