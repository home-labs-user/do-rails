                        ...
                        if (!object1Attributes.length) {
                            ...
                            iterator.each(function(attribute) {
                                ...
                                if (Object.areFromClass(object1AttributeValue,
                                                        object2AttributeValue,
                                                        Boolean)) {
                                    object1AttributeValue = object1AttributeValue
                                        .toString();
                                    object2AttributeValue =
                                        object2AttributeValue.toString();
                                }

                                // testa se está presente, se não estiver ele testa se são iguais lá embaixo??? what a fuck is that?
                                if (object1AttributeValue &&
                                    object2AttributeValue) {
                                    if ($.hasSameClass(object1AttributeValue,
                                        object2AttributeValue)) {
                                        // testa se é instância de objeto
                                        if (object1AttributeValue instanceof
                                            $) {
                                ...
                                } else if (object1AttributeValue ==
                                           object2AttributeValue) {
                                    return true;
                                }
                            });

                            attributesCount = object1Attributes.length;

                            return count == attributesCount;
