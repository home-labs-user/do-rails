        ...
        Object.defineProperties($, {
            flatten: {
                value: function(linkedList) {
                    ...
                    // this way all will be treated as String
        ...
        Object.defineProperties($.prototype, {
            ...
            uniq: {
                value: function() {
                    return this.reduce(function (init, v) {
                        if (init.equivalenceIndexOf(v) == -1) {
                            init.push(v);
                        }
                        return init;
                    }, []);
            ...
            includes: {
                value: function(items) {
                    ...
                    args.forEach(function (arg) {
                        if (mainReference.equivalenceIndexOf(arg) > -1) {
                            count += 1;
                        }
                    });
                ...
                value: function(amount) {
                    ...
                    partsToDelete.forEach(function (i) {
                        ...
                        while(counter-- > 0 && mainReference.count(i)) {
                            index = mainReference.equivalenceIndexOf(i);
                            if (index > -1) {
            ...
            count: {
                value: function (item) {
                    ...
                    while(true) {
                        index = clone.equivalenceIndexOf(item, index + 1);
                        if(index > -1) {
                            count++;
                        } else {
                            break;
            ...
            firstIndexOf: {
                value: function(item) {
                    return this.equivalenceIndexOf(item);
                }
            },
