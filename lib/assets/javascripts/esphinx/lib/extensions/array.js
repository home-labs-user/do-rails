        ...
        Object.defineProperties($.prototype, {
            ...
            insertAt: {
                value: function(values, index) {
                    ...
                    argumentsAsArray.deleteIndex(argumentsAsArray.lastIndex());
                    self.deleteIndex(index, self.lastIndex());
            ...
            intersections: {
                value: function(sets) {
                    ...
                    // reduce works with any value, filter with true or false
            ...
            difference: {
                value: function(sets) {
                    ...
                    sets.uniq().forEach(setsIteratorBlock);
