    ...
    $.prototype.extend({
        ...
        append: function(node) {
            ...
            this.selectEach(function (element) {
                nodes.selectEach(function (node) {
        ...
        text: function (text) {
            ...
            if (typeof text == "string") {
                ...
                if (childNodes.some()) {
                    childNodes.selectEach(function (node) {
        ...
        insertAfter: function(node) {
            ...
            this.selectEach(function (nodeToInsert) {
                nodes.selectEach(function (node) {
                    // element = $(element);
        ...
        constructorClass: function () {
            return window[$.Object.className(this.asNode())];
        },
            ...
            if (object) {
                ...
                if (delay) {
                    window.setTimeout(function () {
                        mainReference.selectEach(function (node) {
