        ...
        prototype: {
            ...
            filter: function (callback) {
                ...
                self.each(function (node, i) {
                    // if (callback.call(void 0, node, i)) {}
                    debugger
                    if (Constructor.build(callback)(node, i)) {
                        filtered.push(val);
                    }
            ...
            findElementByTextContent: function (text) {
                ...
                return self.childElements().filter(function () {
                    return self.rootText().trim() === text.trim();
                });
            },
