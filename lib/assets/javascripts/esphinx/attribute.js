            ...
            params: function () {
                var
                    ...
                    resolveParam = function (name, value) {
                        ...
                        if (/.+\[.+\]\[\]\[.+\]/.test(name)) {
                            // aparentemente saporra funciona
                            structure = "{\"" + structure
                                .replace(/\]\[\]\[/, "\":[{\"")
                                .replace(/\[(?![\{])/g, "\":{\"")
                                .replace(/\]$/g, "\":\"" + value + "\"}]}}");
                            ...
                            // structure = "{\"" + structure;
                            // structure = structure.replace(/\[(?![0-9]+])/g, "\":{\"");
                            // structure = structure.replace(/\]\[[0-9]+\]/g, "\":{\"" + i);
                            // structure = structure
                            //     .replace(/\]$/g, "\":\"" + value + "\"}}}}");
                        } else if (/.+\[.+\]/.test(name)) {
                            structure = "{\"" + structure
                            ...
                            // structure = "{\"" + structure;
                            // structure = structure.replace(/\[/g, "\":{\"");
                            // structure = structure.replace(/\]$/g, "\":\"" + value + "\"}}");
                        } else {
