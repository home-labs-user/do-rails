...
Ajax = (function () {
    ...
    return {
        ...
        new: function (url, options) {
            var
                AjaxConstructor = Constructor.get(Ajax.new, arguments),
                self = this,
                ...
                setRequestHeaders = function (xhr, headers) {
                    if (headers) {
                        Enumerator.each(headers, function (value, header) {
                            if (value) {
                ...
                get = function (xhr, url, params) {
                    if (params) {
                        ...
                        Enumerator.each(params, function (param) {
