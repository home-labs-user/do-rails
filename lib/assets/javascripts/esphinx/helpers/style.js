        ...
        prototype: {
            ...
            width: function (value) {
                ...
                if (value || value === 0) {
                    ...
                    if (Number.isNaN(parseFloat(minWidth))) {
                        return self.first().offsetWidth;
                    }
                    return self.innerWidth() + border;
                }
            },
            ...
            height: function (value) {
                ...
                if (value || value === 0) {
                    ...
                    if (Number.isNaN(parseFloat(minHeight))) {
