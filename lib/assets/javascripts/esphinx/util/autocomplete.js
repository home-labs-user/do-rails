                    ...
                    eventListenerMethod = function(e) {
                        ...
                        if (searchTextBox.value()) {
                            ...
                            if (searchTextLength < previousSearchText.length &&
                                ...
                                // agora pode ser excluído no range de seleção, no entanto qual deve ser recuperado? Faria diferença logicamente? E neste caso, ao ser encontrado, deve ser inserido entre ou no final?
                            ...
                            if (foundElements.some()) {
                                if ((charactersNumber < 0 &&
                                    ...
                                    fillInToRecovery(foundElements,
                                                   charactersNumber);
                                }
                                ...
                                if (searchTextLength > afterAmountCharacters ||
                                    ...
                                    fillInToRecovery(currentElements,
                                                   charactersNumber);
                                }
                            }
