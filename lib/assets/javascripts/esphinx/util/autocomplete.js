                ...
                inlineSearch = function(element, options) {
                    ...
                    eventListenerMethod = function(e) {
                        var
                            ...
                            searchTextDifferente = previousSearchText.length -
                                    searchTextLength,
                        ...
                        if (searchTextBox.value()) {
                            ...
                            finalIndex = startingIndex + searchTextDifferente -
                                1;
                            ...
                            if (searchTextLength > afterAmountCharacters ||
                                ...
                                if (foundElements.some()) {
                                    ...
                                    // debugger
                                    // check if is necessary insert
                                    if (elements2Recovery.length <
                                        searchTextAmount) {

                                        // there was a difference for more
                                        if (searchTextDifferente < 0) {
                                            fillOften = Math
                                                .abs(searchTextDifferente);
                                            // debugger
                                        } else {
                                            fillOften = searchTextAmount -
                                    ...
                                    debugger
                                    // rever critério
                                    if (elements2Recovery.length < fillOften) {
                                        debugger
                                        fillInToRecovery(previousElement,
                                                         fillOften);
                                    } else {
                                        // aparentemente há mais um critério aqui
                                        debugger
                                        fillInToRecovery(previousElement);
                                    }

                                    // usar replaceLast(previousElement); aqui. Mas quando?
                                }
                            }
                            // debugger
