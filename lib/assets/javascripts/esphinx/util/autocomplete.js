                    ...
                    eventListenerMethod = function(e) {
                        if (searchTextBox.value()) {
                            if (searchTextBox.value().length <
                                ...
                                // previousSearchText.length - searchTextBox.value().length - 1
                                // para calcular o índice correto
                                currentElements = elements.clone(true);
                            }
                            ...
                            if (foundElements.some()) {
                                ...
                                // guardar aqui(elements2Recovery.push())
                                // elements2Recovery = foundElements;
