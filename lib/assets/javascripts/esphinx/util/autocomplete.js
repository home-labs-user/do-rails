            ...
            var
                ...
                offlineSearch = function(elementsList, options) {
                    var
                        ...
                        previousElementsList = elementsList,
                        elementsList2Recovery = previousElementsList;
                    ...
                    offlineListener = function(e) {
                        if (searchTextBox.value()) {
                            ...
                            // ainda pode ser considerado a questão de quantos caracteres um tem a menos que o outro
                            if (searchTextBox.value().length <
                                previousSearchText.length) {
                                previousElementsList = elementsList2Recovery
                                    .clone(true);
                            }
                            previousSearchText = searchTextBox.value();

                            resolvedList = resolveList(previousElementsList,
                                options.order);
                            ...
                            if (firstResolvedList.childElements().some()) {
                                elementsList2Recovery = previousElementsList
                                    .clone(true);
                                previousElementsList = firstResolvedList.clone()
                            ...
                            // a clone must be doing cause' one change the another don't.
                            previousElementsList = elementsList.clone(true);
