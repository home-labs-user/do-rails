...
(function ($) {
    ...
    $.extend(true, {
        ...
        Object: {
            ...
            // The keys of associative arrays in JS only can be of integer or string kind. The associations that keys are of Integer kind, the items is sorted according the keys (works as HashSet of the Java). The keys of String kind works as LinkedHashMap, implements a associative array and maintains the order of entrance on iterate
            // TreeMap implements a structure based red-black tree (binary search).
            asHashSet: function (collection) {
