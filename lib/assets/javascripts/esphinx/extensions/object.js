...
(function ($) {
    ...
    Extensor.new($, {
        ...
        lastOfSlice: function (object, slice) {
            for (let key of $.attributes(object).desc()) {
                if (object[key].search(slice) !== -1) {
                    return key;
                }
            }
    ...
    Extensor.new($.prototype, {
        itsEquivalentTo: function (comparator) {
            ...
            // } else if (typeof mainReference === typeof comparator) {
                if (mainReference instanceof $
                    ...
                    if (mainReference instanceof Node) {
                        ...
                        mainReferenceAttrs = $.attributes(mainReference);
                        mainReferenceMethods = $.methods(mainReference);
