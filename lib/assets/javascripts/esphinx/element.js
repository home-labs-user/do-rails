    ...
    $.prototype.extend({
        ...
        selectText: function (start, end) {
            ...
            if (node instanceof window.HTMLInputElement) {
                // o end, na verdade, deve pegar o próximo espaço em branco ou quebra de linha, para tal usar o selectionStart e selectionEnd

                if (!start || start != "number") {
                    $.reverseEach(function (c, i, iterator) {
                        if (c == " ") {
                            start = i;
                            iterator.finalize();
                        }
        ...
        html: function (content) {
            if (typeof content == "string") {
                this.elements().selectEach(function (element) {
