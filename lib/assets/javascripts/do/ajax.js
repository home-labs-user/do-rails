...
var ajaxInit = function(params) {

    params = new HashTable.obj(params);
    params = params.merged(defaults);
...
Ajax = {
    ...
    get: function(params){
        ...
        // acho que o atributo pode ser acessado diretamente com o namespace Ajax.get
        if(params.async) {
