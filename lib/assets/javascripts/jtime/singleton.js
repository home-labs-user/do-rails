...
(function ($) {
    ...
    // os objetos poderão herdar (inherits) desse objeto(Singleton), e esse objeto terá um initialize que receberá o objeto para guardar em instances e um método de instância .singleton, o qual, o objeto que herdar, terá o poder de recuperar um singleton de si.
    var
        instances = [];
